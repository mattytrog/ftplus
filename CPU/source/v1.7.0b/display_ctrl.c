...
#define display_interrupt_hold 50 // * 50 us

void split_value(int32 value, INT8 &d3, int8 &d4, int8 &d5, int8 &d6, int8 &d7, int8 &d8, int8 &d9)
{
   d3  = 0; WHILE (value >= 1000000){value -= 1000000; d3 += 1; }
   d4  = 0; WHILE (value >= 100000){value -= 100000; d4 += 1; }
   d5  = 0; WHILE (value >= 10000){value -= 10000; d5 += 1; }
   d6  = 0; WHILE (value >= 1000){value -= 1000; d6 += 1; }
   d7  = 0; WHILE (value >= 100){value -= 100; d7 += 1; }
   d8  = 0; WHILE (value >= 10) {value -= 10; d8 += 1; }
   d9  = 0; WHILE (value >= 1) {value -= 1; d9 += 1; }
}
   ...
   if(!cycles_to_go)
      {
         ...
         else {i = 0; cycles_to_go = disp_latches;}
...
void t2_isr(void)
{
   if((cat_tx_request) && (!transmitting)) 
   {
         if(valid) Q64_val = 2; 
         transmitting = 1;
   }
   if((!cat_tx_request) && (transmitting)) 
   {
      switch(dl)
      {
         case 0: Q64_val = 0; break;
         case 1: Q64_val = 1; break;
      }   
      if(!tx_mode) transmitting = 0;
   }

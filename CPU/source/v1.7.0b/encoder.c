...
int8 freq_dial_accel(int32 &value, int8 start_increment)
{
   ...
   if(res)
   {
      ...
      if((dial_timer > 0) && (dial_timer < speed1)) {dial_increment = start_increment; report_back = 1;}
      else if((dial_timer >= speed1) && (dial_timer < speed2)) {dial_increment = increment_speed1; report_back = 2;}
      else if((dial_timer >= speed2) && (dial_timer < speed3)) {dial_increment = increment_speed2; report_back = 2;}
      else if((dial_timer >= speed3) && (dial_timer < speed4)) {dial_increment = increment_speed3; report_back = 2;}
      else if((dial_timer >= speed4) && (dial_timer < speed5)) {dial_increment = increment_speed4; report_back = 2;}
      else if((dial_timer >= speed5) && (dial_timer < speed6)) {dial_increment = increment_speed5; report_back = 2;}
      else if(dial_timer >= speed6) {dial_increment = increment_speed6; report_back = 2;}
